...
function copy(tipo: TipoNotificacao, d: DadosNotificacao) {
  switch (tipo) {
    ...
    case "prazo_proximo":
      return {
        eyebrow: "Prazo se aproximando",
        titulo: d.dias === 0 ? `Etapa ${d.numero} vence hoje` : `Etapa ${d.numero} vence em ${d.dias} dia(s)`,
        cor: "#F6C445",
        corpo: `Entrega prevista para <strong>${dataBR(d.data_entrega)}</strong> em ${esc(d.projeto)}.`,
        acao: "Atualizar o andamento",
      };
    case "prazo_vencido":
      return {
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;margin:0 auto">
  <tr><td>
    ...
    <p style="margin:16px 4px 0;color:#5A6A7C;
      ...
      Você recebe este aviso porque participa de um projeto interno da Adecon.
      Para parar, desmarque “receber e-mails” no seu perfil dentro da Central.
    </p>
  </td></tr>
</table>
</body></html>`;
