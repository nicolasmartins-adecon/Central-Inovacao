...
- às 8h de Brasília em dias úteis, procura prazos vencendo.

### 3.5 O que é enviado

| Evento | Quem recebe |
|---|---|
| Etapa ganha responsável (ou muda de data) | responsável da etapa |
| Alguém comenta numa etapa | responsável da etapa |
| Prazo em 3 dias e no dia da entrega | responsável da etapa |
| Prazo vencido | responsável, até concluir ou repactuar |

O e-mail só sai se a etapa tiver **e-mail do responsável** preenchido.
...
- **Console do projeto** — a ficha (objetivo, equipe, metodologia, datas) ao lado da
  trilha de etapas. Clique no número para concluir; clique na etapa para abrir a gaveta
...
- **Conexão** — chaves, perfil, exportar/importar JSON e CSV.
